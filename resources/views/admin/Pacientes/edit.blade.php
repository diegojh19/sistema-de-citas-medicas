                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form group">
                            ...
                            <input type="text" name="nro_seguro" value="{{$paciente->nro_seguro}}" class="form-control" required>
                            @error('nro_seguro')
                            <small class="text-danger" style="color::red">{{$message}}</small>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form group">
                            ...
                            <input type="text" name="celular" value="{{$paciente->celular}}" class="form-control" required>
                            @error('celular')
                            <small class="text-danger" style="color::red">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form group">
                            ...
                            <input type="text" name="correo" value="{{$paciente->correo}}" class="form-control" required>
                            @error('correo')
                            <small class="text-danger" style="color::red">{{$message}}</small>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form group">
                            ...
                            <input type="direccion" name="direccion" value="{{$paciente->direccion}}" class="form-control" required>
                            @error('direccion')
                            <small class="text-danger" style="color::red">{{$message}}</small>
                            @enderror
                        </div>
