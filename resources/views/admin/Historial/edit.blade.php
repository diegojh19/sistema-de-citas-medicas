                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="fecha_visita" name="fecha_visita" class="form-control" value="{{$historial->fecha_visita}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="detalle" class="form-control" id="editor" cols="30" rows="10">{!!$historial->detalle!!}</textarea>
                                        </div>
                                    </div>
                                </div>
