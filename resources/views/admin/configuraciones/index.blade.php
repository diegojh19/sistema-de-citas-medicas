            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{url('admin/configuraciones/create')}}" class="btn btn-primary"> <i class="fa fa-plus"></i>
                            Registrar nuevo
                        </a>
                ...
                <table id="example1"class="table table-striped table-bordered table-hover table-sm">
                    <thead style="background-color: #c0c0c0">
                        ...
                        <td style="text-align: center"> <b>Hospital/Clinica</td>
                        <td style="text-align: center"> <b>Ubicacion</td>
                        <td style="text-align: center"> <b>Teléfono</td>
                        <td style="text-align: center"> <b>Correo</td>
                        <td style="text-align: center"> <b>Logo</td>
                    ...
                    <tbody>
                        ...
                        @foreach($configuraciones as $configuracione)
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset('storage/'.$configuracione->logo)}}" alt="logo" width="100px">
                                </td>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{url('admin/configuraciones/'.$configuracione->id)}}" class="btn btn-info"><i class="bi bi-eye"></i></a>
                                        <a href="{{url('admin/configuraciones/'.$configuracione->id.'/edit')}}" class="btn btn-success"><i class="bi bi-pencil"></i></a>
                                        <a href="{{url('admin/configuraciones/'.$configuracione->id.'/confirm-delete')}}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
