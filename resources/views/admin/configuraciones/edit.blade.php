                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form group">
                                        ...
                                        <input type="text" name="nombre" value="{{$configuracion->nombre}}"  class="form-control" required>
                                        @error('nombre')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form group">
                                        ...
                                        <input type="email" name="correo" value="{{$configuracion->correo}}" class="form-control" required>
                                        @error('correo')
                                        <small class="text-danger" style="color::red">{{$message}}</small>
                                        @enderror
                                    </div>
