...
@section('content')
    <div class="row">
        <h1>Reporte de reservas de citas medicas</h1>
    </div>
    <hr>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <a href="{{url('admin/reservas/pdf')}}" class="btn btn-success" target="_blank"><i class="bi bi-printer"></i> Listado de todas las reservas</a>
                </div>
            </div>
        </div>
    </div>
