                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form group">
                            ...
                            <input type="text" name="monto" value="{{$pago->monto}}" class="form-control" required>
                            @error('monto')
                    ...
                    <div class="col-md-6">
                        <div class="form group">
                            ...
                            <input type="descripcion" name="descripcion" value="{{$pago->descripcion}}" class="form-control" required>
                            @error('descripcion')
                            <small class="text-danger" style="color::red">{{$message}}</small>
                            @enderror
                        </div>
